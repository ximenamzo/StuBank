    ...
    <div class="container">
        ...
        <form action="comprobar_register.php" method="post" class="form-registro" enctype="multipart/form-data">
            ...
            <div class="contenedor-inputs">
                <input type="text" name="nCuenta" onkeypress="return SoloLetras(event);" placeholder="Cuenta del trabajador" class="input-50" minlength="8" maxlength="8" required>
                ...
                <input type="tel" minlength="10" maxlength="10" name="telefono_user" onkeypress="return valideKey(event);" placeholder="Telefono" class="input-100" required>
                <input type="email" name="correo_user" class="input-100" placeholder="Email" required>
                <input type="text" name="curp" minlength="18" maxlength="18" class="input-100" placeholder="CURP" required>
                <label class="yearday">Fecha de nacimiento: </label>
                <input type="date" name="fecNac" class="input-50" min="1952-01-01" max="2004-06-01" required>
                ...
                <input type="submit" value="Añadir Registro" class="btn_enviar">
            </div>
        </form>
    </div>
</body>
