                ...
                <form action="setEdit.php" method="post" enctype="multipart/form-data">
                    ...
                    <div style="width: 100%;" class="row">
                        <div style="width: 33%;">
                            ...
                            <input type="text" name="nom" id="nom" class="form-control" value="<?=$cliente['nombre']?>" required><br>
                        </div>
                        <div style="width: 33%;">
                            <label class="form-label">Apellido paterno:</label>
                            <input type="text" name="aP" id="aP" class="form-control" value="<?=$cliente['apellidoP']?>" required><br>
                        </div>
                        <div style="width: 33%;">
                            <label class="form-label">Apellido materno:</label>
                            <input type="text" name="aM" id="aM" class="form-control" value="<?=$cliente['apellidoM']?>" required><br>
                        </div>
                    </div>
                    <div class="row">
                        <div style="width: 32%;">
                            <label class="form-label">Teléfono:</label>
                            <input type="text" name="tel" id="tel" class="form-control" value="<?=$cliente['telefono']?>" maxlength="10" required><br>
                        </div>
                        <div style="width: 64%;">
                            <label class="form-label">Correo electronico:</label>
                            <input type="email" name="email" id="email" class="form-control" value="<?=$cliente['email']?>" required><br>
                        </div>
                    </div>
                    <div class="row">
                        <div style="width: 48%;">
                            <label class="form-label">CURP:</label>
                            <input type="text" name="curp" id="curp" class="form-control" value="<?=$cliente['curp']?>" maxlength="18" required><br>
                        </div>
